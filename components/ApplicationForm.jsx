...
const questions = [
  {
    ...
    options: [
      "Продаж послуг",
      "Продаж товарів",
      "Презентувати компанію або особистіть",
      "Показувати додаткову інформацію клієнтам",
      "Інше",
    ],
  },
  {
  ...
  },
  {
    ...
    options: ["Так", "Ні", "Тільки логотип", "Тільки назва"],
  },
  {
    id: 4,
    question: "Уявляєте дизайн, який бажаєте?",
    options: ["Так", "Орієнтовно", "Ні, потірбна допомога"],
  },
];
