      ...
      <div className="container">
        ...
        <ul className={style.problem__items}>
          ...
          <li className={style.problem__item}>
            <div className={style.title__container}>
              <Certificate
                ...
                className={style.problem__svg}
              />
              <p className={style.item__title}>Пишемо копірайтинг, що продає</p>
            </div>
          ...
          <li className={style.problem__item}>
            ...
            <p className={style.item__text}>
              Грунтуючись на аналізі, вирішуємо болі ваших клієнтів, прописуємо
              правильні смисли і створюємо унікальну пропозицію. Правильні
              кольори, кнопки, розташування елементів сайту.
            </p>
          </li>
          <li className={style.problem__item}>
            <div className={style.title__container}>
